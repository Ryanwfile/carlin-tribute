import carlin_cardinalGlick from "./images/carlin_cardinalGlick.jpg"
import carlin_looksLikeJackNicholson from "./images/carlin_looksLikeJackNicholson.png";
import carlin_middleage_bigSmile from "./images/carlin_middleage_bigSmile.jpg";
import carlin_middleage_handsForwardClench from "./images/carlin_middleage_handsForwardClench.jpg";
import carlin_middleage_leaningForward from "./images/carlin_middleage_leaningForward.jpg";
import carlin_middleage_okGesture from "./images/carlin_middleage_okGesture.webp";
import carlin_mugshot from "./images/carlin_mugshot.png";
import carlin_old_gestureTowards from "./images/carlin_old_gestureTowards.jpg";
import carlin_old_micAndStare from "./images/carlin_old_micAndStare.jpg";
import carlin_old_sidewaysWithMic from "./images/carlin_old_sidewaysWithMic.jpg";
import carlin_older_angryStare from "./images/carlin_older_angryStare.jpg";
import carlin_older_okGesture from "./images/carlin_older_okGesture.jpg";
import carlin_veryold_shoulderShrug from "./images/carlin_veryold_shoulderShrug.jpg";
import carlin_veryyoung_funnyMouth from "./images/carlin_veryyoung_funnyMouth.jpg";
import carlin_young_goofyFace from "./images/carlin_young_goofyFace.jpeg";
import carlin_young_googlyEyed from "./images/carlin_young_googlyEyed.jpg";
import carlin_young_shortHairPondering from "./images/carlin_young_shortHairPondering.jpg";
...
export const CONSTANTS = {
    ...
    He was known for his dark comedy and reflections on politics, the English language, psychology, religion, and taboo subjects. His 
    "seven dirty words" routine was central to the 1978 United States Supreme Court case F.C.C. v. Pacifica Foundation, in which a 5–4 decision 
    affirmed the government's power to censor indecent material on the public airwaves.

    The first of Carlin's 14 stand-up comedy specials for HBO was filmed in 1977. From the late 1980s onwards, his routines focused on sociocultural 
    criticism of American society. He often commented on American political issues and satirized American culture. He was a frequent performer and 
    guest host on The Tonight Show during the three-decade Johnny Carson era and hosted the first episode of Saturday Night Live in 1975. His final 
    comedy special, It's Bad for Ya, was filmed less than four months before his death from cardiac failure. In 2008, he was posthumously awarded the 
    Mark Twain Prize for American Humor. In 2004, he placed second on Comedy Central's list of top 10 American comedians. In 2017, Rolling Stone 
    magazine ranked him second (behind Richard Pryor) on its list of the 50 best stand-up comedians of all time.
    ...
    Medium	
    Stand-upfilmtelevisionradioliterature
    Years active	1956–2008
    Genres	
    Observational comedycharacter comedysurreal comedyblue comedydark comedywordplaysarcasmironysatire
    Subject(s)	
    American culturesocietypoliticspsychologyphilosophyprofanityeveryday lifenihilismreligionmisanthropydrug uselanguagemass mediapopular culturecurrent eventsdeathmasculinityfamilyparentingrace relationsold age
    ...
    QUOTES: [
        ...
        {
            quote: "E-I-E-I-O is actually a gross misspelling of the word farm"
        },
        {
            quote: 'Best seller really only means "good seller." There can only be one best seller. All the rest are good sellers. Each succeeding book on the list is a "better seller."'
        },
        {
            quote: "If you mail a letter to the post office, who delivers it?"
        },
        {
            quote: "Is it illegal to charge admission to a free-for-all?"
        },
        {
            quote: "One of my favorite things to do at a party is smoke a bunch of PCP and start taking people’s rectal temperatures without permission"
        },
        {
            quote: "As a matter of principle I never attend the first annual anything."
        },
        {
            quote: "Honesty may be the best policy, but it’s important to remember that, apparently, by elimination, dishonesty is the second best policy.  Second is not all that bad."
        },
        {
            quote: "I was reading a fitness magazine that had an article about cross-training, and I realized this would have been a good idea for Jesus."
        },
        {
            quote: "Recent polls reveal that some people have never been polled.  Until recently."
        },
        {
            quote: "If you vote once, you’re considered a good citizen.  If you vote twice, you face four years in jail."
        },
        {
            quote: "I've never owned a telescope, but it's something I'm thinking of looking into."
        },
        {
            quote: "How do you know when a moth farts? It flies in a straight line"
        },
        {
            quote: "TRUE FACT A radio commercial says that a certain diet pill works three times faster than starvation.  Question: Are they guessing, or did they really run these tests?"
        },
        {
            quote: "If a man smiles all the time he's probably selling something that doesn't work"
        },
        {
            quote: "Think of how stupid the average person is, and then realize half of them are stupider than that."
        },
        {
            quote: "How can crash course and collision course have two different meanings?"
        },
        {
            quote: "No one is ever more herself or himself than when they really laugh."
        },
        {
            quote: "If you love someone, set them free; if they come home, set them on fire"
        },
        {
            quote: "The straightest line between a short distance is two points."
        },
        {
            quote: "Elevators and escalators do more than elevate and escalate. They also lower. The names tell only half the story."
        },
        {
            quote: "I was taken to the hospital for observation.  I stayed several days, didn’t observe anything, and left."
        },
        {
            quote: "I was expelled from cooking school, and it left a bad taste in my mouth."
        },
        {
            quote: "Don’t you lose faith in your dog’s intelligence when he takes a piss and then steps in it?"
        },
        {
        ...
        {
            quote: "I have no ax to grind, but I do have an ivory letter opener that could use sharpening."
        },
        {
            quote: "I don't have to tell you it goes without saying there are some things better left unsaid. I think that speaks for itself. The less said about it the better."
        },
        {
            quote: "I had no shoes, and I felt sorry for myself until I met a man with no feet.  I took his shoes.  Now I feel better."
        },
        {
            quote: "When someone is impatient and says, I haven't got all day, I always wonder, How can that be? How can you not have all day?"
        },
        {
            quote: "Shouldn’t a complimentary beverage tell you what a fine person you are?"
        },
        {
            quote: "If the bouncer gets drunk, who throws him out?"
        },
        {
            quote: "Whenever I see a large crowd I always think of all the dry cleaning they have out."
        },
        {
            quote: "Why does Filipino start with an F and Philippines start with Ph?"
        },
        {
            quote: "How come none of these boxers seem to have a losing record?"
        },
        {
            quote: "Well, if crime fighters fight crime and fire fighters fight fire, what do freedom fighters fight? They never mention that part to us, do they?"
        },
        {
            quote: "The word bipartisan usually means some larger-than-usual deception is being carred out."
        },
        {
            quote: "No one can ever know for sure what a deserted area looks like."
        },
        {
            quote: "I read that some guy was giving up the governor's chair to run for a Senate seat. Why would he give up a chair to run for a seat? Why not be a judge and sit on the bench?"
        },
        {
        ...
        {
            quote: "When will the rhetorical questions all end?"
        },
        {
            quote: "If you want to keep your dog in line, walk him past the fur shop a couple of times a week."
        },
        {
            quote: "There are only two places in the world:over here and over there."
        },
        {
            quote: "I have a photograph of Judge Bork, but it doesn't do him justice."
        },
        {
            quote: "Although the photographer and the art thief were close friends, neither had ever taken the other's picture"
        },
        {
            quote: "Tonight's forecast: DARK!  Continued mostly dark tonight turning to widely scattered LIGHT in the morning"
        }
    ],
    SOUNDS: [
        // {
        //     src: "https://www.wavsource.com/snds_2020-10-01_3728627494378403/people/comedians/carlin_people.wav",
        //     name: "I Like People"
        // },
        {
        ...
        // },
        {
            src: "https://www.skeptic.ca/Sound_Clips/George_Carlin/Carlin-Businessmen.mp3",
            name: "Businessman"
        },
        {
            src: "https://www.skeptic.ca/Sound_Clips/George_Carlin/Carlin-Religion_Bullshit.mp3",
            name: "Religious BS"
        },
        {
            src: "https://www.skeptic.ca/Sound_Clips/George_Carlin/Carlin-No_God.mp3",
            name: "god's existence"
        },
        {
            src: "https://www.skeptic.ca/Sound_Clips/George_Carlin/Carlin-Bible.mp3",
            name: "bible"
        },
        {
            src: "https://www.skeptic.ca/Sound_Clips/George_Carlin/Carlin-Praying.mp3",
            name: "praying"
        },
        {
            src: "https://www.skeptic.ca/Sound_Clips/George_Carlin/Carlin-Sun_Worship.mp3",
            name: "sun worship"
        },
        {
            src: "https://www.skeptic.ca/Sound_Clips/George_Carlin/Carlin-Angels.mp3",
            name: "angels"
        },
        {
            src: "https://www.skeptic.ca/Sound_Clips/George_Carlin/Carlin-Motivation_Seminars.mp3",
            name: "motivational seminars"
        },
        {
            src: "https://www.skeptic.ca/Sound_Clips/George_Carlin/Carlin-Family_Newsletters.mp3",
            name: "family newsletters"
        },
        {
            src: "https://www.skeptic.ca/Sound_Clips/George_Carlin/Carlin-Parents_of_Honor_Students.mp3",
            name: "parents of honor students"
        },
        {
            src: "https://www.skeptic.ca/Sound_Clips/George_Carlin/Carlin-Dumb_Americans.mp3",
            name: "dumb Americans"
        },
        {
    ...
    IMAGES: [
        {   name: "George Carlin 1975, according to the file I copied",
            src:  george_Carlin_1975
        },
        {   name: "George smiling with a mic, ok I will stop describing the pictures now, you either can see or can't read this",
            src:  carlin_younger_micWithSmile
        },
        {   name: "George Carlin",
            src:  carlin_young_withBeardAndMic
        },
        {   name: "George Carlin",
            src:  carlin_young_shortHairPondering
        },
        {   name: "George Carlin",
            src:  carlin_young_googlyEyed
        },
        {   name: "George Carlin",
            src:  carlin_young_goofyFace
        },
        {   name: "George Carlin",
            src:  carlin_veryyoung_funnyMouth
        },
        {   name: "George Carlin",
            src:  carlin_veryold_shoulderShrug
        },
        {   name: "George Carlin",
            src:  carlin_older_okGesture
        },
        {   name: "George Carlin",
            src:  carlin_older_angryStare
        },
        {   name: "George Carlin",
            src:  carlin_old_sidewaysWithMic
        },
        {   name: "George Carlin",
            src:  carlin_old_micAndStare
        },
        {   name: "George Carlin",
            src:  carlin_old_gestureTowards
        },
        {   name: "Probably not taken in church",
            src:  carlin_mugshot
        },
        {   name: "George Carlin",
            src:  carlin_middleage_okGesture
        },
        {   name: "George Carlin",
            src:  carlin_middleage_leaningForward
        },
        {   name: "George Carlin",
            src:  carlin_middleage_handsForwardClench
        },
        {   name: "George Carlin",
            src:  carlin_middleage_bigSmile
        },
        {   name: "George Carlin",
            src:  carlin_looksLikeJackNicholson
        },
        {   name: "George Carlin as cardinal Glick in the movie Dogma",
    ...
    BRAIN_DROPPINGS : `I don't believe there's any problem in this country, no matter how tough it is, that Americans, when they roll up their sleeves, can't completely ignore.

            At one point in my haste to improve myself, I mixed up the telephone numbers of Shick Center for the Control of Smoking and the Evelyn Woods Speed Reading School.  As a result, I can now smoke up to 300 cigaretts a minute, but I gave up reading.
            
            On the other hand, the founders of the major religions had names that seem quite suitable.  There's still a certain mystery surrounding the names Buddha, Moses, and Mohammed.  But the poor Mormons.  All they could come up with was Joseph Smith.  Not too impressive. 
            ...
            "Why?"
            "Joe Smith said that's where we're supposed to be."
            "Well, I'm gonna finish this crossword.  Why don'tcha drop me a postcard."
    ...
    PORK_CHOPS: ` THOU SHALT NOT COVET THY NEGHBOR’S GOODS
            ...
            KEVIN: Jeez.  I’ll never forget that house the Naughtons lived in.  Kind of a cute little place with the green shutters.
            RAY: Hit by lighting fifteen years ago.  Burned to the ground.  All the pets were killed.
            KEVIN: Jeez.  That’s too bad.  I remember the Naughtons always like that house because it was so close to the church.
            ...
            RAY: Dorian’s collapse ten years ago and killed nineteen customers.  The entire Halloran family was decapitated at the butcher counter while they were pickin’ out meat.
            ...
            “Pardon me, Officers.  Would you fellows mind dragging that twisted-looking chap over here a little closer to the car?  My wife has never seen anyone shaped quite like that.”
    ...
    LAST_WORD: ` "Sliding headfirst down a vagina with no clothes on and landing in the freshly shaven crotch of a screaming woman did not seem to be part of God's plan for me.  At least not at first.  I'm not one of those people who can boast of having been a sparkle in his mother's eye.  A cinder comes closer." "Popular ethnic slurs to the contrary, the Irish do enjoy sex-at least the last ten seconds or so.  But we must admit that Irish foreplay consists of little more than 'You awake?' Or the more caring, sensitive 'Brace yourself, Agnes!'" 
           ...
           A fifth-grade autobiography assignment I still have required a closing paragraph on "What I want to be when I grow up."  I wrote, "When I grow up I'd like to be an actor, impersonator, comedian, disc jockey announcer or trumpet player." 
           ...
           (Referring to Second City)  I could do material in these places I didn’t always trust to a nightclub: about integration, the John Birch Society, the Ku Klux Klan. 
    ...
    NAPALM: `A Florida man who wrestles alligators for a living was eaten alive today when the alligator apparently did not understand the universal signal for “time-out.”
