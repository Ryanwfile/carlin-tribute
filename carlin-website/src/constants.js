...
export const CONSTANTS = {
  ABOUT: {
    title: "About George Carlin",
    content: `George Denis Patrick Carlin (May 12, 1937 – June 22, 2008) was an American stand-up comedian, actor, author, and social critic. 
  ...
  QUOTES: [
    ...
    {
      quote:
        "No one is ever more herself or himself than when they really laugh.",
    },
    {
      quote:
    ...
    {
      quote:
        "The word bipartisan usually means some larger-than-usual deception is being carred out.",
    },
    {
    ...
    {
      quote:
        "I have a photograph of Judge Bork, but it doesn't do him justice.",
    },
    {
      quote:
  ...
  IMAGES: [
    ...
    { name: "George Carlin", src: carlin_young_withBeardAndMic },
    { name: "George Carlin", src: carlin_young_shortHairPondering },
    { name: "George Carlin", src: carlin_young_googlyEyed },
    { name: "George Carlin", src: carlin_young_goofyFace },
    { name: "George Carlin", src: carlin_veryyoung_funnyMouth },
    { name: "George Carlin", src: carlin_veryold_shoulderShrug },
    { name: "George Carlin", src: carlin_older_okGesture },
    { name: "George Carlin", src: carlin_older_angryStare },
    { name: "George Carlin", src: carlin_old_sidewaysWithMic },
    { name: "George Carlin", src: carlin_old_micAndStare },
    { name: "George Carlin", src: carlin_old_gestureTowards },
    { name: "Probably not taken in church", src: carlin_mugshot },
    { name: "George Carlin", src: carlin_middleage_okGesture },
    { name: "George Carlin", src: carlin_middleage_leaningForward },
    { name: "George Carlin", src: carlin_middleage_handsForwardClench },
    { name: "George Carlin", src: carlin_middleage_bigSmile },
    { name: "George Carlin", src: carlin_looksLikeJackNicholson },
    {
  ...
  BRAIN_DROPPINGS: {
    ...
    content: `I don't believe there's any problem in this country, no matter how tough it is, that Americans, when they roll up their sleeves, can't completely ignore.
  ...
  LAST_WORDS: {
    image: {
      name: "Last Words With Tony Hendra",
      src: "https://images-na.ssl-images-amazon.com/images/I/51Ci9Naaz0L._SX322_BO1,204,203,200_.jpg",
    },
